 ...
 *
 *   $Id: defs_i386_um.h 974 2011-08-08 08:52:20Z rd235 $
 *
 */   
#ifndef _DEFS_I386
#define _DEFS_I386
...
{
	GDEBUG(3, "\033[01;33m \nsaved_regs:eax:%x(%d)\torig_eax:%x(%d)\n\tebx:%x(%d)\tecx:%x(%d)\n\tedx:%x(%d)\tesi:%x(%d) \033[0m",
			pc->saved_regs[EAX],	pc->saved_regs[EAX],
			pc->saved_regs[ORIG_EAX],	pc->saved_regs[ORIG_EAX],
			pc->saved_regs[EBX],	pc->saved_regs[EBX],
			pc->saved_regs[ECX],	pc->saved_regs[ECX],
			pc->saved_regs[EDX],	pc->saved_regs[EDX],
			pc->saved_regs[ESI],	pc->saved_regs[ESI]);
/*
