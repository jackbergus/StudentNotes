 ...
 *
 *   $Id: defs_x86_64_um.h 974 2011-08-08 08:52:20Z rd235 $
 *
 */   
...
{
	GDEBUG(3, "\033[01;33m \nsaved_regs:rax:%x(%d)\torig_rax:%x(%d)\n\trdi:%x(%d)\trsi:%x(%d)\n\trdx:%x(%d)\tr10:%x(%d) \033[0m",
			pc->saved_regs[MY_RAX],	pc->saved_regs[MY_RAX],
			pc->saved_regs[MY_ORIG_RAX],	pc->saved_regs[MY_ORIG_RAX],
			pc->saved_regs[MY_RDI],	pc->saved_regs[MY_RDI],
			pc->saved_regs[MY_RSI],	pc->saved_regs[MY_RSI],
			pc->saved_regs[MY_RDX],	pc->saved_regs[MY_RDX],
			pc->saved_regs[MY_R10],	pc->saved_regs[MY_R10]);
}
